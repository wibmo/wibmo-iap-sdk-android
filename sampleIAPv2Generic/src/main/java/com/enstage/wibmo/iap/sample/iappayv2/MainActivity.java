package com.enstage.wibmo.iap.sample.iappayv2;
...
public class MainActivity extends ActionBarActivity {
    ...
    //test data for txn
    private long amount = 200;
    private String lastWibmoTxnId;

    private Activity activity;
    private TextView outputMainView;
    private TextView outputStatusView;
    private TextView outputChargeView;
    private View buttonPayWithWibmo;
    private View buttonCheckStatus;
    private View buttonChargeCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputMainView = (TextView) findViewById(R.id.output_main);
        outputStatusView = (TextView) findViewById(R.id.output_status);
        outputChargeView = (TextView) findViewById(R.id.output_charge);

        buttonPayWithWibmo = (View) findViewById(R.id.pww_button);
        buttonCheckStatus = (View) findViewById(R.id.button_check_status);
        buttonChargeCard = (View) findViewById(R.id.button_charge);

        TextView amountView = (TextView) findViewById(R.id.title_3);
        amountView.setText(""+(amount/100.00));//convert to decimals

        buttonPayWithWibmo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                outputStatusView.setText("");
                outputChargeView.setText("");
        ...
        buttonChargeCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                doChargeCard();
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == WibmoSDK.REQUEST_CODE_IAP_PAY) {
            ...
            outputMainView.setText(sb.toString());
        }// requestCode
    }//onActivityResult
    ...
    private class StatusCheckTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (showError) {
                ...
                outputStatusView.setText(output);
            }
        }
    }
    ...
    private class ChargeCardTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (showError) {
                ...
                outputChargeView.setText(output);
            }
        }
    }
